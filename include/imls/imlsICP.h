...
#ifndef SAVEPCD_IMLSICP_H
#define SAVEPCD_IMLSICP_H
...
//namespace lidar_slam{
    ...
    public:
        ...
        void setSourcePointCloud(pcl::PointCloud<pcl::PointXYZ>& _pcl_cloud);
        ...
        //求解四阶多项式
        bool SolverFourthOrderPolynomial(Eigen::VectorXd& p_coff,double& lambda);
    ...
    private:
        void RemoveNAN_INFData(std::vector<Eigen::Vector2d>& _input);
